...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ParticipanteProyecto'
        db.create_table(u'proyectos_participanteproyecto', (
            ...
            ('fecha_agregado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('estado', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'proyectos', ['ParticipanteProyecto'])


    def backwards(self, orm):
        # Deleting model 'ParticipanteProyecto'
        db.delete_table(u'proyectos_participanteproyecto')
    ...
    models = {
        ...
        u'proyectos.participanteproyecto': {
            'Meta': {'object_name': 'ParticipanteProyecto'},
            'estado': ('django.db.models.fields.BooleanField', [], {}),
            'fecha_agregado': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
